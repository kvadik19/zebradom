...
### wp-plugins
В директорию темы добавлена поддиректория `wp-plugins`, в которой хранятся измененные по каким-либо причинам плуги. Для работы wordpress с директории `wp-content/plugins` создаются симлинки или копии файлов соответствующих поддиректорий. Проверять после выполненния `git pull`!
