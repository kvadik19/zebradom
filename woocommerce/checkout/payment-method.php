...
?>
<div class="cell-item payment_method wc_payment_method payment_method_<?php echo esc_attr( $gateway->id ); ?><?php $gateway->chosen ? ' sel' : '' ?>" 
		data-method="<?php echo esc_attr( $gateway->id ); ?>"
		title="<?php echo $gateway->get_option('instructions') ?>" >
	<input id="payment_method_<?php echo esc_attr( $gateway->id ); ?>" type="radio" class="input-radio" name="payment_method" 
			...
			data-order_button_text="<?php echo esc_attr( $gateway->order_button_text ); ?>" hidden />
